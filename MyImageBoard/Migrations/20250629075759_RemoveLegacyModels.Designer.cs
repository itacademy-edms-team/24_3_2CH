...
namespace ForumProject.Migrations
{
    ...
    [Migration("20250629075759_RemoveLegacyModels")]
    partial class RemoveLegacyModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ForumProject.Data.Models.Like", b =>
                {
                    ...
                    b.HasIndex("UserFingerprintId", "CommentId", "LikeTypeId")
                        .IsUnique()
                        .HasFilter("[CommentId] IS NOT NULL");

                    b.HasIndex("UserFingerprintId", "ThreadId", "LikeTypeId")
                        .IsUnique()
            ...
            modelBuilder.Entity("ForumProject.Data.Models.LikeType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ForumProject.Data.Models.Like", b =>
                {
                    ...
                    b.HasOne("ForumProject.Data.Models.LikeType", "LikeType")
                        .WithMany("Likes")
